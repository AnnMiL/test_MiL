...
hold on;
text(stopx-1.5, height,'$t^{zero}_{ii}$','Interpreter','latex','FontSize',fontSize);
text(stopx+2.2, height,'$H_{ii}\approx 0$','Interpreter','latex','FontSize',fontSize);
