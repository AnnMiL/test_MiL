...
plot(2:1:size(TemA,2)+1, TemA,'Color',[0.04313, 0, 0.42352],'Marker','v',...
    'MarkerSize',msize,'linewidth',2);
hold on
plot(2:1:size(TemB,2)+1, TemB, 'g-o', 'MarkerSize',msize,'linewidth',2);
hold on
plot(2:1:size(TemS,2)+1, TemS,'Color',[0.4784,0.02745,0.02745],'Marker',...
    'h', 'MarkerSize',msize,'linewidth',2);
hold on 
plot(2:1:size(TemF,2)+1, TemF,'Color','r','Marker','*', 'MarkerSize',msize,...
    'linewidth',2);
hold on 
